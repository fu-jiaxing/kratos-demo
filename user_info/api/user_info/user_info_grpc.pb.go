...
func (c *userInfoClient) GetUserInfo(ctx context.Context, in *GetUserInfoRequest, opts ...grpc.CallOption) (*GetUserInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.user_info.UserInfo/GetUserInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserInfoServer) GetUserInfo(context.Context, *GetUserInfoRequest) (*GetUserInfoReply, error) {
...
func _UserInfo_GetUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user_info.UserInfo/GetUserInfo",
	}
...
var UserInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.user_info.UserInfo",
	...
	Metadata: "api/user_info/user_info.proto",
}
